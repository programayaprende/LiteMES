	                        ...
	                        <div class="dropdown dropdown-inline">\
	                            ...
	                            <div class="dropdown-menu dropdown-menu-sm dropdown-menu-right">\
	                                <ul class="navi flex-column navi-hover py-2">\
	                                    ...
	                                    <li class="navi-item">\
	                                        <a href="javascript: quickEdit(\'' + row.id + '\',\'Approve\')" class="navi-link">\
	                                            <span class="navi-icon"><i class="la la-print"></i></span>\
	                                            <span class="navi-text">Approve</span>\
	                                        </a>\
	                                    </li>\
	                                    <li class="navi-item">\
	                                        <a href="javascript: quickEdit(\'' + row.id + '\',\'Lock\')" class="navi-link">\
	                                            <span class="navi-icon"><i class="la la-copy"></i></span>\
	                                            <span class="navi-text">Lock role</span>\
	                                        </a>\
	                                    </li>\
	                                    <li class="navi-item">\
	                                        <a href="javascript: quickEdit(\'' + row.id + '\',\'Unlock\')" class="navi-link">\
	                                            <span class="navi-icon"><i class="la la-file-excel-o"></i></span>\
	                                            <span class="navi-text">Active role</span>\
	                                        </a>\
	                                    </li>\
	                                </ul>\
	                            </div>\
	                        </div>\
	                        <a href="javascript: window.location= BASE_URL + \'/Roles/Edit/' + row.id + '\' ;" class="btn btn-sm btn-default btn-text-primary btn-hover-primary btn-icon mr-2" title="Edit details">\
	                            <span class="svg-icon svg-icon-md">\
...
function quickEdit(role_name,action){
	$.ajax({
		url: BASE_URL + "/Roles/" + action + "/" + role_name,
		dataType: "json",
		cache: false,
		contentType: false,
		processData: false

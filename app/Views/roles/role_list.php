						...
						<div class="subheader py-2 py-lg-4 subheader-solid" id="kt_subheader">
							<div class="container-fluid d-flex align-items-center justify-content-between flex-wrap flex-sm-nowrap">
								...
								<div class="d-flex align-items-center flex-wrap mr-2">
									<!--begin::Title-->
									<h5 class="text-dark font-weight-bold mt-2 mb-2 mr-5">Query Roles</h5>
									<!--end::Title-->
									<!--begin::Separator-->
								...
								<div class="d-flex align-items-center">
									...
									<!--begin::Button-->
									<a href="<?= base_url("/Roles/New")?>" class="btn btn-light-primary font-weight-bold ml-2">Add role</a>
									<!--end::Button-->
										...
										<div class="card card-custom ">
											...
											<div class="card-body" style="padding-left:20px; padding-right:20px;">
												...
												<div class="form-group">
													...
													<input type="text" class="form-control" id="filter_name"  placeholder="Enter role name"/>
												</div>
											</div>
										</div>
									</div>

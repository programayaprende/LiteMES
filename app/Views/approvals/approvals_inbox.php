        ...
        <div class="container-fluid d-flex align-items-center justify-content-between flex-wrap flex-sm-nowrap">
            ...
            <div class="d-flex align-items-center flex-wrap mr-1">
                ...
                <div class="d-flex align-items-baseline flex-wrap mr-5">
                    <!--begin::Page Title-->
                    <h5 class="text-dark font-weight-bold my-1 mr-5">Approvals</h5>
                    <!--end::Page Title-->
                </div>
                <!--end::Page Heading-->
            </div>
            ...
            <div class="d-flex align-items-center">
                <!--begin::Actions-->
                <a href="#" class="btn btn-light-primary font-weight-bolder btn-sm btn-new-approval">New Approval</a>
                <!--end::Actions-->                
            </div>
        </div>
    </div>
                        ...
                        <div class="card-body px-5">                            
                            ...
                            <div class="navi navi-hover navi-active navi-link-rounded navi-bold navi-icon-center navi-light-icon">
                                ...
                                <div class="navi-item my-2">
                                    <a href="javascript: KTAppInbox.showPendings()" class="navi-link activexx">
                                        ...
                                        <span class="navi-text font-weight-bolder font-size-lg">Pendings</span>
                                ...
                                <!--begin::Item-->
                                <div class="navi-item my-2">
                                    <a href="javascript: KTAppInbox.showApproved()" class="navi-link">
                                        <span class="navi-icon mr-4">
                                            <span class="svg-icon svg-icon-lg">
                                ...
                                <!--begin::Item-->
                                <div class="navi-item my-2">
                                    <a href="javascript: KTAppInbox.showConcent()" class="navi-link">
                                        <span class="navi-icon mr-4">
                                            <span class="svg-icon svg-icon-lg">
                                                <!--begin::Svg Icon | path:assets/media/svg/icons/General/Half-star.svg-->
                                                <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1">
                                        ...
                                        <span class="navi-text font-weight-bolder font-size-lg">Concent</span>
                                    </a>
                                </div>
                                <!--end::Item-->
                                <!--begin::Item-->
                                <div class="navi-item my-2">
                                    <a href="javascript: KTAppInbox.showRejected()" class="navi-link">
                                        <span class="navi-icon mr-4">
                                            <span class="svg-icon svg-icon-lg">
                                                <!--begin::Svg Icon | path:assets/media/svg/icons/General/Half-star.svg-->
                                                <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1">
                                        ...
                                        <span class="navi-text font-weight-bolder font-size-lg">Rejected</span>
                                    </a>
                                </div>
                                <!--end::Item-->
                                <!--begin::Item-->
                                <div class="navi-item my-2">
                                    <a href="javascript: KTAppInbox.showNotifications()" class="navi-link">
                                        <span class="navi-icon mr-4">
                                            <span class="svg-icon svg-icon-lg">
                                ...
                                <!--begin::Item-->
                                <div class="navi-item my-2">
                                    <a href="javascript: KTAppInbox.showSent()" class="navi-link">
                                        <span class="navi-icon mr-4">
                                            <span class="svg-icon svg-icon-lg">

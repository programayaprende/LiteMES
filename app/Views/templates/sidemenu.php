						...
						<div id="kt_aside_menu" class="aside-menu my-4" data-menu-vertical="1" data-menu-scroll="1" data-menu-dropdown-timeout="500">
							...
							<ul class="menu-nav">
								...
								<li class="menu-section">
									<h4 class="menu-text">System Configuration</h4>
										...
										<ul class="menu-subnav">
													...
													<ul class="menu-subnav">
														<li class="menu-item" aria-haspopup="true">
															<a href="<?=base_url()?>/Users" class="menu-link">
																...
																<span class="menu-text">Query Users</span>
															</a>
														</li>														
														<li class="menu-item" aria-haspopup="true">
											...
											<li class="menu-item menu-item-submenu" aria-haspopup="true" data-menu-toggle="hover">
												...
												<div class="menu-submenu">
													...
													<ul class="menu-subnav">
														<li class="menu-item" aria-haspopup="true">
															<a href="<?=base_url("Roles/List")?>" class="menu-link">
																<i class="menu-bullet menu-bullet-dot">
																	<span></span>
																</i>
																<span class="menu-text">Query Roles</span>
															</a>
														</li>														
														<li class="menu-item" aria-haspopup="true">
								...
								<li class="menu-section">
									<h4 class="menu-text">Production Managment</h4>
									<i class="menu-icon ki ki-bold-more-hor icon-md"></i>
								</li>
								<li class="menu-item menu-item-submenu" aria-haspopup="true" data-menu-toggle="hover">
									<a href="javascript:;" class="menu-link menu-toggle">
										...
										<ul class="menu-subnav">
											...
											<li class="menu-item" aria-haspopup="true">
												<a href="layout/themes/aside-light.html" class="menu-link">
													...
													<span class="menu-text">Query Plan</span>
												</a>
											</li>
											<li class="menu-item" aria-haspopup="true">
												<a href="layout/themes/aside-light.html" class="menu-link">
											...
											<li class="menu-item" aria-haspopup="true">
												<a href="layout/themes/aside-light.html" class="menu-link">
													...
													<span class="menu-text">Edit Plan</span>
												</a>
											</li>
										...
										<ul class="menu-subnav">
											...
											<li class="menu-item" aria-haspopup="true">
												<a href="layout/subheader/toolbar.html" class="menu-link">
													...
													<span class="menu-text">Input Result</span>
												</a>
											</li>
											<li class="menu-item" aria-haspopup="true">
												<a href="layout/subheader/toolbar.html" class="menu-link">
													...
													<span class="menu-text">Result Status</span>
												</a>
											</li>
										</ul>
									</div>
								...
								<li class="menu-section">
									<h4 class="menu-text">Inventory Managment</h4>
									<i class="menu-icon ki ki-bold-more-hor icon-md"></i>
								</li>
								<li class="menu-item menu-item-submenu" aria-haspopup="true" data-menu-toggle="hover">
									<a href="javascript:;" class="menu-link menu-toggle">
										...
										<ul class="menu-subnav">
											...
											<li class="menu-item" aria-haspopup="true">
												<a href="layout/themes/aside-light.html" class="menu-link">
													...
													<span class="menu-text">Input Item</span>
												</a>
											</li>
											<li class="menu-item" aria-haspopup="true">
												<a href="layout/themes/aside-light.html" class="menu-link">
													...
													<span class="menu-text">Output Item</span>
												</a>
											</li>
											<li class="menu-item" aria-haspopup="true">
												<a href="layout/themes/aside-light.html" class="menu-link">
													...
													<span class="menu-text">Transfer Item</span>
												</a>
											</li>
										...
										<ul class="menu-subnav">
											...
											<li class="menu-item" aria-haspopup="true">
												<a href="layout/subheader/toolbar.html" class="menu-link">
													...
													<span class="menu-text">Location Balance</span>
												</a>
											</li>
											<li class="menu-item" aria-haspopup="true">
												<a href="layout/subheader/toolbar.html" class="menu-link">
													...
													<span class="menu-text">Item Balance</span>
												</a>
											</li>
											<li class="menu-item" aria-haspopup="true">
												<a href="layout/subheader/toolbar.html" class="menu-link">
													...
													<span class="menu-text">Negative Balance</span>
												</a>
											</li>
											<li class="menu-item" aria-haspopup="true">
												<a href="layout/subheader/toolbar.html" class="menu-link">
													...
													<span class="menu-text">Aging Report</span>
												</a>
											</li>
											<li class="menu-item" aria-haspopup="true">
												<a href="layout/subheader/toolbar.html" class="menu-link">
										...
										<ul class="menu-subnav">
											...
											<li class="menu-item menu-item-submenu" aria-haspopup="true" data-menu-toggle="hover">
												<a href="javascript:;" class="menu-link menu-toggle">
													...
													<span class="menu-text">Restock Condition</span>
													<span class="menu-label">
														<span class="label label-rounded label-primary">6</span>
													</span>
													<i class="menu-arrow"></i>
													...
													<ul class="menu-subnav">
														<li class="menu-item" aria-haspopup="true">
															<a href="custom/apps/user/list-default.html" class="menu-link">
																...
																<span class="menu-text">Query Condition</span>
															</a>
														</li>														
														<li class="menu-item" aria-haspopup="true">
															<a href="custom/apps/user/add-user.html" class="menu-link">
																...
																<span class="menu-text">Add Condition</span>
															</a>
														</li>
														<li class="menu-item" aria-haspopup="true">
															<a href="custom/apps/user/edit-user.html" class="menu-link">
																...
																<span class="menu-text">Edit Condition</span>
															</a>
														</li>
													</ul>
												</div>
											...
											<li class="menu-item menu-item-submenu" aria-haspopup="true" data-menu-toggle="hover">
												<a href="javascript:;" class="menu-link menu-toggle">
													...
													<span class="menu-text">Product BOM</span>
													<span class="menu-label">
														<span class="label label-rounded label-primary">6</span>
													</span>
													<i class="menu-arrow"></i>
													...
													<ul class="menu-subnav">
														<li class="menu-item" aria-haspopup="true">
															<a href="custom/apps/user/list-default.html" class="menu-link">
																...
																<span class="menu-text">Query BOM</span>
															</a>
														</li>														
														<li class="menu-item" aria-haspopup="true">
															<a href="custom/apps/user/add-user.html" class="menu-link">
																...
																<span class="menu-text">Add BOM</span>
															</a>
														</li>
														<li class="menu-item" aria-haspopup="true">
															<a href="custom/apps/user/edit-user.html" class="menu-link">
																...
																<span class="menu-text">Edit BOM</span>
															</a>
														</li>
													</ul>
												</div>
										...
										<ul class="menu-subnav">
											...
											<li class="menu-item" aria-haspopup="true">
												<a href="<?=base_url()?>/Approvals/New" class="menu-link">
													...
													<span class="menu-text">Add Approval</span>
												</a>
											</li>
										</ul>
									</div>
								</li>
								<li class="menu-item menu-item-submenu d-none" aria-haspopup="true" data-menu-toggle="hover">
									<a href="javascript:;" class="menu-link menu-toggle">
										<span class="svg-icon menu-icon">
											<!--begin::Svg Icon | path:assets/media/svg/icons/Design/Bucket.svg-->
											<svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1">
